    ...
    data(){
        return{
            fr: {
                ...
                home_titre_1: "Près de chez toi Franc-Comtois !",
                home_text_1: "Plus besoin de te déplacer jusqu'à Paris pour assister à un événement geek majeur ! Avec la Super Geeky Week tu peux maintenant profiter de tous types d'activités geek près de chez toi. Localisé dans la nouvelle salle de Belfort, la Gigantomachie, tu pourras profiter de 3 jours de folie !",
                home_titre_2: "Une myriade d'activités !",
                home_text_2: "Au programme toutes les activités dont tu peux rêver et plus encore ! Avec de prestigieux invités avec des séances d'autographes et des goodies par milliers pour être certain que tu gardes, même jusque chez toi, un souvenir inoubliable de ce week-end fantastique !",

                billet_title:"Billeterie",
                billet_text:"Pour la Super Geeky Week, nous vous proposons trois types de forfaits pour rendre votre séjour encore plus agréable. Tout d'abord, le forfait standard vous permettra de profiter pleinement de tous les stands. Ensuite, nous vous offrons le forfait prioritaire qui vous garantit un accès plus rapide à nos services, vous permettant ainsi de maximiser votre temps et votre expérience. Enfin, pour assurer une accessibilité optimale, nous avons également le forfait dédié aux personnes en situation de handicap.",
                jour:"Jour ",
                hora:" / Horaire de ",
                a:" a ",
                ...
                ressource:"Ressource",
                emplressources:"Emplacements des ressources",
                calendrier:"Calendrier",
                lignepanier:"Ligne du panier",
